...
def gas_only_pressure_drop(m: Container) -> list[Equation]:
    ...
    weymouth_correlation[j,pf,d,t].where[selected_pipes[j,pf,d] & tp[t]] =  (pressGAS[pf, t]*pressGAS[pf, t])*(1e3**2) <= pressSQ[j,t]*(1e3**2) - (qGAS_interSQ[j, pf, d, t]*((1e3/m3_to_cf)**2))*kw[j,pf,d] # kPa --> MPa
