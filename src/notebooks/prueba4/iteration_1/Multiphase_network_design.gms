...
$onMultiR
$gdxLoadAll c:\Users\Diego\Desktop\ExxonMobil\LM_Gathering\src\notebooks\prueba4\iteration_1\Multiphase_network_design_data.gdx
$offMulti
...
ixlm_interval(j,pf,d,t,pw) $ (tp(t) and ord(pw) <= allowed_int(j,pf,d,t)) .. deltaPgas(j,pf,t) =l= (ixlm_ub(pw,j,pf,d,t) - 1000.0) * deltaPliq(j,pf,d,t) + 10 * dp_max * (1 - x_pw(j,pf,d,t,pw)) + 10 * dp_max * (1 - sum(tt $ (ord(tt) <= ord(t) and tp(tt)),x_bar(j,pf,d,tt)));
